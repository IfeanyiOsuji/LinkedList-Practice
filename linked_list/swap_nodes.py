...
def swap_nodes(head, left_index, right_index):
    ...
    current_node = head
    new_head = None
    prev_node_at_left_index = None
    curr_node_at_left_index = None
    prev_node_at_right_index = None
    curr_node_at_right_index = None
    current_index = 0
    while current_node is not None:
        if current_index == left_index:
            curr_node_at_left_index = current_node
        elif current_index == right_index:
            curr_node_at_right_index = current_node
            break
        if curr_node_at_left_index is None:
            prev_node_at_left_index = current_node
        prev_node_at_right_index = current_node

        current_node = current_node.next
        current_index +=1

    prev_node_at_right_index.next = curr_node_at_left_index
    temp = curr_node_at_left_index.next
    curr_node_at_left_index.next = curr_node_at_right_index.next
    curr_node_at_right_index.next = temp

    if prev_node_at_left_index is None:
        new_head = curr_node_at_right_index
    else:
        prev_node_at_left_index.next = curr_node_at_right_index
        new_head = head
    return new_head
